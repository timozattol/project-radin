...
public class UserJSONParserTest extends AndroidTestCase{
	...
	protected void setUp() throws Exception {
		...
		modelList.add(new UserModel(FIRSTNAME, LASTNAME, EMAIL, ADDRESS, IBAN, PICTURE, ID));
		modelList.add(new UserModel(FIRSTNAME2, LASTNAME2, EMAIL2, ADDRESS2, IBAN2, PICTURE2, ID2));
