...
public class RadinGroupJSONParser implements JSONParser<RadinGroupModel> {
    ...
    public List<JSONObject> getJsonFromModels(List<RadinGroupModel> modelList) {
        ...
        try {
            ...
            json.put("RG_CREATION_DATE", "today"); // or 2014/01/01/00/00
            ...
            json.put("RG_END_DATE", "tomorrow"); // or 2014/01/01/01/01
            json.put("RG_DELETED_AT", "after-tomorrow"); // or 2014/01/01/01/02
